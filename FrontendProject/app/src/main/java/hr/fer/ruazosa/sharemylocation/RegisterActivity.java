...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mail = (EditText) findViewById(hr.fer.ruazosa.sharemylocation.R.id.editmail);
        password = (EditText) findViewById(hr.fer.ruazosa.sharemylocation.R.id.editpass);
        repeatPassword = (EditText) findViewById(hr.fer.ruazosa.sharemylocation.R.id.repeatpassword);
